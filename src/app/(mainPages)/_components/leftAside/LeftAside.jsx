...
const leftSideLinks = [
  ...
  { img: SettingsIcon.src, hoverImg: "", title: "Settings", path: "/settings" },
];

const LeftAside = () => {

  return (
    <aside className="flex flex-col justify-between bg-white shadow-[0_4px_10px_0_rgba(0,0,0,0.10)] min-w-[243px]  pl-6 pb-[25px] py-4">
