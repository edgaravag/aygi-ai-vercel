...
import ImageComp from "../../../public/laptop.png";
...
const WelcomeSection = () => {
  ...
  return (
    <>
      <section className='center min-h-[633px] gap-0 xl:gap-10 max-[1160px]:gap-12 flex-wrap w-full h-full px-10 max-[975px]:px-3 bg-[url("../../public/welcome.png")] bg-cover bg-center pb-[84px] pt-[208px]'>
        <div>
          ...
          <p className="text-black text-lg font-normal mt-5 leading-6 max-[1160px]:text-center">
            Enhance Your Gardening Journey, all <br /> what your plant need in
            one app.
          </p>
          <Button
        ...
        <div className="center flex-wrap gap-x-9 gap-y-8 max-[1160px]:gap-x-40 max-[990px]:gap-x-36 max-[885px]:gap-x-28">
          ...
          <div className="center flex-wrap gap-12 max-[661px]:gap-20">
            <div className="flex items-center max-[1160px]:flex-row-reverse max-[1160px]:mr-7 max-[850px]:mr-0">
              <div className='center h-[212px] w-[2px] bg-[url("../../public/welcomeLine.png")] max-[1160px]:ml-[34px] max-[918px]:hidden'>
