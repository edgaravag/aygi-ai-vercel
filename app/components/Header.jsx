...
const Header = () => {
  ...
  return (
    <>
      <header className="fixed z-10 h-auto py-[29px] flex justify-around items-center flex-wrap bg-black w-full gap-x-12 gap-y-5 px-4 2xl:px-[237px] xl:px-32 lg:px-14 sm:justify-between sm:px-10">
        <div>
