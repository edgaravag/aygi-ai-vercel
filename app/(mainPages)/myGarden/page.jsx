...
const diaries = [
  { diaryName: "Diary Name", creationDate: "05 March", img: DiaryImg.src, description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.", isPrivate: true },
  { diaryName: "Diary Name", creationDate: "05 March", img: DiaryImg.src, description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.", isPrivate: false },
  { diaryName: "Diary Name", creationDate: "05 March", img: DiaryImg.src, description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.", isPrivate: false },
  { diaryName: "Diary Name", creationDate: "05 March", img: DiaryImg.src, description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.", isPrivate: true },
  { diaryName: "Diary Name", creationDate: "05 March", img: DiaryImg.src, description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.", isPrivate: false },
  { diaryName: "Diary Name", creationDate: "05 March", img: DiaryImg.src, description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.", isPrivate: false },
              ...
              <div xmlns="http://www.w3.org/1999/xhtml">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g id="content/add_24px">
                    <path id=" &#226;&#134;&#179;Color" fillRule="evenodd" clipRule="evenodd" d="M15.8827 10.7518H11.1769V15.2616H9.60823V10.7518H4.90234V9.24857H9.60823V4.73877H11.1769V9.24857H15.8827V10.7518Z" fill="#68BB59"/>
                  </g>
                </svg>
              </div>
            </foreignObject>
              ...
              <div key={diary.title} className="w-[344px]">
                <div className="flex justify-between items-center gap-14">
                  <div className="flex flex-col p-3 pb-2">
                    ...
                    <p className="text-sm font-normal text-[#808080]">{diary.creationDate}</p>
                  </div>
                  <div className="cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                      <g clipPath="url(#clip0_3369_7837)">
                      <path d="M11.1159 3.02331L1.21212 12.9279C1.16225 12.9779 1.12671 13.0403 1.1092 13.1087L0.0114199 17.5149C-0.00472561 17.5803 -0.00373616 17.6487 0.0142927 17.7136C0.0323216 17.7785 0.0667806 17.8377 0.114341 17.8853C0.187394 17.9581 0.286304 17.9991 0.389444 17.9992C0.421261 17.9991 0.452956 17.9952 0.483812 17.9875L4.88995 16.8895C4.95846 16.8723 5.02099 16.8368 5.07086 16.7868L14.9756 6.88289L11.1159 3.02331ZM17.4292 1.67283L16.3267 0.570409C15.5899 -0.166413 14.3057 -0.165682 13.5697 0.570409L12.2192 1.92089L16.0787 5.78032L17.4292 4.42988C17.7972 4.06198 17.9999 3.57227 17.9999 3.05145C17.9999 2.53063 17.7972 2.04091 17.4292 1.67283Z" fill="#808080"/>
                      </g>
                      <defs>
